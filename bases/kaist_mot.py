...
class KaistMOT(BaseDatasetTracking):
    ...
    def generate_dataset_statistics(self):
        ...
        self.dataset_statistics['dataset_name'] = 'Kaist MOT'
        self.dataset_statistics['video_count'] = len(self.videos)
        self.dataset_statistics['description'] = 'Kaist for Multiple Object Tracking'
