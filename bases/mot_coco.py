...
class MOT_IN_COCO(BaseDatasetTracking):
    ...
    def generate_dataset_statistics(self):
        ...
        self.dataset_statistics['dataset_name'] = 'MOT'
        self.dataset_statistics['video_count'] = len(self.videos)
        self.dataset_statistics['description'] = 'Multiple Object Tracking'
        self.dataset_statistics['created_by'] = 'MOT'
