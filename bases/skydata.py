...
class SkyData(BaseDataset):
    def __init__(self, annotation_file=None):
        """
        Class to load and create index for skydata dataset. Dataset is created by OzerLabs.
        The dataset is designated for 3 main vision tasks being : detection, segmentation, and tracking tasks.
        We create annotations based on the COCO data format.   
