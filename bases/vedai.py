...
class VEDAI(BaseDataset):
    ...
    def generate_dataset_statistics(self):
        ...
        self.dataset_statistics['dataset_name'] = "Vedai"                                                                                                                                                                                                                   
        self.dataset_statistics['dataset_size'] = len(self.dataset['images'])
        self.dataset_statistics['description'] = 'Vedai dataset'
        self.dataset_statistics['created_by'] = 'Vedai'
