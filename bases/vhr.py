...
class VHR10(BaseDataset):
    ...
    def generate_dataset_statistics(self):
        ...
        self.dataset_statistics['dataset_name'] = "VHR10"                                                                                                                                                                                                                   
        self.dataset_statistics['dataset_size'] = len(self.dataset['images'])
        self.dataset_statistics['description'] = 'VHR10 dataset'
        self.dataset_statistics['created_by'] = 'VHR10'
