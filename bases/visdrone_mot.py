...
class VisDroneMOT(BaseDatasetTracking):
    ...
    def generate_dataset_statistics(self):
        ...
        self.dataset_statistics['dataset_name'] = 'Visdrone MOT'
        self.dataset_statistics['video_count'] = len(self.videos)
        self.dataset_statistics['description'] = 'Visdrone for Multiple Object Tracking'
    ...
    def createIndex(self):
        ...
        if 'annotations' in self.dataset:
            for ann in tqdm(self.dataset['annotations']):
                ...
                anns[ann['id']] = ann
                if(ann["instance_id"] not in list(adjustedAnns.keys())):
