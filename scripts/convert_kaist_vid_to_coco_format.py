...
from utils import conversion_kaist_vid_tools
...
parsed_annotations = conversion_kaist_vid_tools.convert_kaist_to_coco(annotations_dir)  
print(f"\n[INFO] Converting kaist to coco format completed.")

# # save the json file
utilities.save_json(data=parsed_annotations, 
                    save_dir=str(_outputdir),
                    file_name="kaist_vid_cocoformat.json")  