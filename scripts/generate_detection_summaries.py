...
# ## 10. UAV123 dataset
# 
# from bases.uav123 import UAV123
# from pathlib import Path
# 
# import os
# 
# 
# converted_path = Path("./data/uav123/converted_annotations")
# annotation_file = converted_path / "uav123_converted_to_coco_format.json"
# 
# 
# 
# # if annotation_file does not exist, convert the dataset
...
#         #TODO this could be improved 
#         # The script could take arguments 
#         print("[INFO] Converting uav123 dataset to COCO format...")
#         os.system("python ./scripts/convert_uav123_to_coco_format.py")
#         print("[INFO] Finished converting dataset to COCO format.")
#     except:
#         print("[ERROR] Could not convert dataset to COCO format.")
#         exit(1)
# 
# D = UAV123(annotation_file=str(annotation_file))
# 
# # generate and load stats
# D.generate_dataset_statistics()
# 
