...
kaist-pedestrian/
    ...
    |   |-> set01/
    |   |-> ...
    |-> annotations-json/ # generated by `kaist_to_coco_format.py` script
...
def instance2xml_base(anno, img_size, bbox_type='xywh'):
    ...
    # print("[DEBUGGIN]anno['bbox']: {}".format(anno['bbox']))
...
if __name__ == "__main__":
    db_path = os.path.join(os.path.dirname(__file__), ".." ,'data/kaist_pedestrian/')
