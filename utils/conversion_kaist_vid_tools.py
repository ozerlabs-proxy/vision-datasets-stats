...
def get_per_frame_annotations(per_frame_anns : dict,
                                ...
                                video_id= None) -> tuple[dict, list, list]:
...
def convert_kaist_to_coco(vbb_inputdir):
    ...
    for video_i, sub_dir in tqdm(enumerate(sub_dirs,1)):
        ...
        for video_ii, vbb_file in enumerate(vbb_files,1):  
            ...
            if annos:                
                ...
                video_id=f"{video_i}{video_ii}"
                video = {
                        "id": video_id,
                        "file_name": sub_dir,
                        "width": int(IMAGE_SIZE[0]),
                        "height": int(IMAGE_SIZE[1]),
                        "file_names": list(annos.keys()),
                        "length": len(list(annos.keys())),
                    }
                kaist_coco_format["videos"].append(video)
